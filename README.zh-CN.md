<a href="https://dotfei.github.io/Learn-From-Failure/">
  <picture>
    ...
    <img alt="Learn From Failure（从失败中学习）—— 一个按失败机制分类、可查证来源的企业失败案例知识库，点击浏览网站" src="https://cdn.jsdelivr.net/gh/DOTfei/Learn-From-Failure@main/assets/banner-light.svg" width="100%">
  </picture>
</a>
...
- **这是评论分析，不是给谁定罪。** 指控、起诉、民事/监管调查结果，都会如实标注成"指控/
  起诉/调查结果"，不会说成"已被判有罪"，除非真的有法院判决。详见 [LEGAL.md](LEGAL.md)（英文），
  里面也说明了怎么申请更正。
...
CHANGELOG.md                     — 版本更新记录
CODE_OF_CONDUCT.md               — 贡献者与讨论的行为准则
LEGAL.md                         — 信源标准、商标、更正流程
```
...
单一来源的复制——具体细节请查阅每个案例的来源链接。商标使用、指控与定罪的区分、更正流程，
详见 [LEGAL.md](LEGAL.md)（英文）。
