...
- [ ] 我们是不是把客户的预付款/押金当成了别的用途的营运资金，而不是留着对应它本该支付的义务？
...
## 文化与人才
_参考案例：[kodak](cases/kodak.md)、[nokia-mobile](cases/nokia-mobile.md)、[sears](cases/sears.md)、[borders](cases/borders.md)、[circuit-city](cases/circuit-city.md)、[myspace](cases/myspace.md)、[boeing-737-max](cases/boeing-737-max.md)（波音 737 MAX）_
...
- [ ] 员工私下有没有提过安全/质量/道德方面的顾虑，但从来没有通过正式渠道被反映出来？

## 安全与品质
_参考案例：[boeing-737-max](cases/boeing-737-max.md)（波音 737 MAX）_

- [ ] 我们做某个安全/品质相关的决定，是为了绕开某项披露、审批或培训要求，而不是真的让产品更安全/更好？
- [ ] 有没有某个关键系统或流程依赖单一失效点，而且已经有人提出过这个风险？
- [ ] 我们团队是不是在自己给自己的安全/品质做认证，完全没有真正独立的第三方检查？
- [ ] 竞争对手或赶工期的压力，是不是正在逼我们在安全或品质上抄一个平常不会抄的近路？
